...
#    Updated: 2024/10/29 13:35:27 by pleander         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
builtins := $(addprefix ./src/builtins/, builtins.c builtin_env.c builtin_export.c builtin_unset.c builtin_pwd.c builtin_cd.c)
