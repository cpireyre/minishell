...
#    Updated: 2024/11/14 13:08:33 by pleander         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
execute := $(addprefix ./src/execute/, execute_ast.c make_command.c pipe.c run_builtin.c logicals.c minishell_execve.c execute_utils.c execute_single_cmd.c execute_cmd.c execute_pipeline.c make_command_utils.c handle_redir.c)
